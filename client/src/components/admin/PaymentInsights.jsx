...
function PaymentInsights() {
    ...
    const lineChartData = {
        labels: ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'], // Update labels to display the days of the week
        datasets: [
            {
            ...
            <div className="payment-insight">
                <div className="insight-cards">
                    <div className="total-amount-card">
                        <div style={{ marginTop: "20px", fontSize: "18px", fontWeight: "bold" }}>Total Amount</div>
                        <div style={{ marginTop: "20px", fontSize: "32px", fontWeight: "bold" }}>{paymentData.reduce((acc, payment) => acc + payment.amount, 0)} LKR</div>
                    </div>
                    <div className="total-transaction-card">
                        <div style={{ marginTop: "20px", fontSize: "18px", fontWeight: "bold" }}>Transaction Count</div>
                        <div style={{ marginTop: "20px", fontSize: "32px", fontWeight: "bold" }}>{paymentData.length}</div>
                    </div>
                </div>
                ...
                <div>
                    <div className="payment-table-top">
                        ...
                        <div clssName="export-payment-btn">
                            <button className="export-payment-csv">Export Csv</button>
                        </div>
                    </div>
                </div>
                <div className="payment-table"><Table columns={columns} dataSource={formattedPaymentData} /></div>
            </div>
        </div>
